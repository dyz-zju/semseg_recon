...
tf.flags.DEFINE_string("logs_dir", "logs_vggf16/", "path to logs directory")
...
def inference(image, keep_prob):
    ...
    with tf.variable_scope("inference"):
        ...
        W_t3 = utils.weight_variable([32, 32, NUM_OF_CLASSESS, deconv_shape1[3].value], name="W_t3")
        b_t3 = utils.bias_variable([NUM_OF_CLASSESS], name="b_t3")
        conv_t3 = utils.conv2d_transpose_strided(fuse_1, W_t3, b_t3, output_shape=deconv_shape3, stride=16)
